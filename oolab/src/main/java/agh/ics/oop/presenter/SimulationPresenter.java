...
public class SimulationPresenter implements MapChangeListener {
    ...
    public void updateBounds(){
        xMin = map.getCurrentBounds().lowerBound().getX();
        yMin = map.getCurrentBounds().lowerBound().getY();
        xMax = map.getCurrentBounds().upperBound().getX();
        yMax = map.getCurrentBounds().upperBound().getY();
    ...
    private void startSimulation(){
        ...
        List<MoveDirection> directions = OptionParser.parser(moveList.split(" "));
